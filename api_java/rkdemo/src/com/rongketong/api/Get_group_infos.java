 ...
 *				gname: 组名称				
**/ 
@WebServlet("/get_group_infos.php")
public class Get_group_infos extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger m_logger = Logger.getLogger(Get_group_infos.class);    
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			userList = MysqlBaseManager.get_group_infos(accountInfo.get("user_account"));
	    	if(userList!=null){
			...
			m_logger.info(String.format("FAILED params=%s","receve groupMessage error,error cause:"+e.getCause()));
		}
